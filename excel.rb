...
@if_excel = Roo::Excelx.new("IF.xlsx")
@fs_excel = Roo::Excelx.new("FS.xlsx")
...
Axlsx::Package.new do |p|
  p.workbook.add_worksheet(:name => "Table") do |sheet|
    sheet.add_row ["customer", "terms", "limit", "total", "current", "1~15", "16~30", "31~60", "over 60"]
    @service.datas.each do |data|
